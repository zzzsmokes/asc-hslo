...
!function e(t, r, n) {
    ...
    1: [function(e, t, r) {
        function n(e, t, r, n) {
            ...
            this.addFrame = function(t, r, n, s, f, u) {
                ...
                var _ = !1
                  , w = 0;
                if (void 0 !== u.transparent && null !== u.transparent && (_ = !0,
                w = u.transparent,
                0 > w || w >= c))
        ...
        function i(e, t, r, n) {
            ...
            a(f),
            i(1),
            o + 1 === t ? e[o] = 0 : (e[o] = t - o - 1,
            e[t++] = 0),
            t
        }
        function a(e) {
            var t = 0;
            if (71 !== e[t++] || 73 !== e[t++] || 70 !== e[t++] || 56 !== e[t++] || 56 !== (e[t++] + 1 & 253) || 97 !== e[t++])
        ...
        function o(e, t, r, n) {
            for (var i = e[t++], a = 1 << i, o = a + 1, s = o + 1, h = i + 1, f = (1 << h) - 1, u = 0, l = 0, d = 0, c = e[t++], p = new Int32Array(4096), v = null; ; ) {
                for (; 16 > u && 0 !== c; )
                    l |= e[t++] << u,
                    u += 8,
                    1 === c ? c = e[t++] : --c;
            ...
            return d !== n && console.log("Warning, gif stream shorter than expected."),
            r
        }
        try {
            r.GifWriter = n,
    ...
    , {}],
    2: [function(e, t, r) {
        var n, i, a, o, s, h, f, u = function(e, t) {
            return function() {
        ...
        h = function(e) {
            ...
            r.responseType = "arraybuffer",
            {
                ...
                frames: function(e, t, n) {
                    ...
                    i = s(e),
                    r.onload = f(function(e) {
                        return e.onDrawFrame = t,
                        e.animateInCanvas(i, n)
                    }),
                    r.send(),
                    this
                }
        ...
        s = function(e) {
            var t, r;
            if ("string" == typeof e && "CANVAS" === (null != (r = t = document.querySelector(e)) ? r.tagName : void 0))
                return t;
            if ("CANVAS" === (null != e ? e.tagName : void 0))
                return e;
        ...
        o = function(e, t) {
            ...
            .apply(this).map(function(t) {
                return function(t) {
                    var r;
                    return r = e.frameInfo(t),
                    r.pixels = new Uint8ClampedArray(e.width * e.height * 4),
        ...
        n = function() {
            ...
            return e.prototype.start = function() {
                return this._lastTime = (new Date).valueOf(),
            ...
            e.prototype._nextFrameRender = function() {
                var e, t;
                if (this._running)
                    return e = this._frames[this._frameIndex],
                    null != (t = this.onFrame) && t.apply(this, [e, this._frameIndex]),
                    this._enqueueNextFrame()
            }
            ,
            e.prototype._advanceFrame = function() {
                this._frameIndex += 1,
                this._frameIndex >= this._frames.length && (0 !== this._loopCount && this._loopCount === this._loops ? this.stop() : (this._frameIndex = 0,
                this._loops += 1))
            }
            ,
            e.prototype._enqueueNextFrame = function() {
                ...
                for (this._advanceFrame(); this._running; ) {
                    if (r = this._frames[this._frameIndex],
            ...
            e.prototype.animateInCanvas = function(e, t) {
                var r;
                return null == t && (t = !0),
                t && (e.width = this.width,
                e.height = this.height),
                r = e.getContext("2d"),
                null == this.onDrawFrame && (this.onDrawFrame = function(e, t, r) {
                    return e.drawImage(t.buffer, t.x, t.y)
                }
                ),
                null == this.onFrame && (this.onFrame = function(t) {
                    return function(n, i) {
                        var o, s;
                        switch (null == n.buffer && (n.buffer = a(n, t.width, t.height)),
                        "function" == typeof t.disposeFrame && t.disposeFrame(),
                        n.disposal) {
                        case 2:
                        ...
                        return null != (o = t.onDrawFrame) ? o.apply(t, [r, n, i]) : void 0
                    }
                }(this)),
                this.start(),
                this
        ...
        "undefined" != typeof window && null !== window && (window.gifler = h),
